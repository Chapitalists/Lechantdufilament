...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 697.0, 505.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 697.0, 539.0, 120.0, 22.0 ],
					"style" : "",
					"text" : "send ToOSC_seqGo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 389.0, 227.0, 47.0 ],
					"style" : "",
					"text" : "Pour commander depuis MAX/MSP les lampes public et l'envoi d'une sequence dans DLight "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 574.0, 548.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "100 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 583.0, 78.0, 22.0 ],
					"style" : "",
					"text" : "send ToOSC"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 361.0, 491.0, 78.5, 22.0 ],
									"style" : "",
									"text" : "int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 361.0, 411.0, 78.5, 22.0 ],
									"style" : "",
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 361.0, 451.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "uzi 10"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 234.25, 457.0, 97.5, 47.0 ],
									"style" : "",
									"text" : "delay évite pb de reception OSC de Dlight"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 226.0, 506.0, 56.0, 22.0 ],
									"style" : "",
									"text" : "delay 50"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.0, 309.0, 150.0, 20.0 ],
									"style" : "",
									"text" : "lancer un sub dans dLight"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 226.0, 358.0, 154.0, 22.0 ],
									"style" : "",
									"text" : "t 1 i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.0, 300.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "r ToOSC_seqGo"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 361.0, 551.0, 125.0, 22.0 ],
									"style" : "",
									"text" : "sprintf /seq/goto %ld"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 599.5, 98.0, 60.0, 22.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 646.0, 178.0, 145.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 615.0, 181.0, 22.0 ],
									"style" : "",
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"OscParams" : [ "169.254.101.149", 8000 ],
						"OscParams[1]" : [ 8001 ],
